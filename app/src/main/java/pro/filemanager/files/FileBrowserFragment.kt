    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity.requestExternalStoragePermission {
            ...
            ApplicationLoader.ApplicationIOScope.launch {
                ...
                viewModel = ViewModelProviders.of(this@FileBrowserFragment, SimpleInjector.provideFileBrowserViewModelFactory(requireArguments().getString(FileCore.KEY_ARGUMENT_PATH)!!)).get(FileBrowserViewModel::class.java)

                if(viewModel.path == FileCore.KEY_INTERNAL_STORAGE) {
                ...
                } else if(viewModel.path == FileCore.KEY_EXTERNAL_STORAGE) {
...
//                              TODO: No SD card found
    ...
    override fun onDestroy() {
        ...
        if(this::viewModel.isInitialized)
            viewModel.mainListRvState = (binding.fragmentFileBrowserList.layoutManager as GridLayoutManager).onSaveInstanceState()
